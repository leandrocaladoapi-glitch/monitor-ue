...
# -*- coding: utf-8 -*-
"""
selftest_offline_eu.py — Testes offline do pipeline do monitor UE
(adicional ao monitor brasileiro, que tem o seu próprio selftest).

Não toca na rede nem no dataset do repositório: copia `data/legislation-eu` para
...
import update_legislation_eu as ul  # noqa: E402
import update_sources_eu as us      # noqa: E402
...
def copiar_dataset(destino):
    ...
    for nome in os.listdir(os.path.join(BASE, "data", "legislation-eu")):
        shutil.copy(os.path.join(BASE, "data", "legislation-eu", nome), destino)
    return destino
